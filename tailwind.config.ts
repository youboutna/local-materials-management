	...
	theme: {
		...
		extend: {
			colors: {
				...
				adrar: {
					50: 'hsl(var(--adrar-50))',
					100: 'hsl(var(--adrar-100))',
					200: 'hsl(var(--adrar-200))',
					300: 'hsl(var(--adrar-300))',
					400: 'hsl(var(--adrar-400))',
					500: 'hsl(var(--adrar-500))',
					600: 'hsl(var(--adrar-600))',
					700: 'hsl(var(--adrar-700))',
					800: 'hsl(var(--adrar-800))',
					900: 'hsl(var(--adrar-900))'
				},
				ivory: {
					50: '#FFFFFF',
					100: '#FCFAF7',
			...
			fontFamily: {
				...
				serif: ['var(--font-serif)', 'Lora', 'Amiri', 'Georgia', 'serif'],
			},
			backgroundImage: {
