...
-- ============================
-- 0. SUPPRIMER LES UTILISATEURS EXISTANTS (pour éviter les conflits)
-- ============================
-- ⚠️ Cette opération supprime les utilisateurs avec ces emails
-- Décommenter si vous voulez les remplacer
...
INSERT INTO public.profiles (
    ...
    ('bb01aec4-397d-4830-ab5c-7d5e0b21b704', 'Somelect Director', '+222414141412', '757412023', 'director', false, 'active'),
    ('23e1401c-a4fb-48be-810b-26605d65a40e', 'somelect manager', '+222414141402', '42242512', 'manager', false, 'active'),
    ('a139c5d3-64a9-49d6-9ed8-a97d6a27ad07', 'Ebyou Business', '02414774174', '02414774174', 'admin', true, 'active'),
    ('c1ae55a7-f752-48fb-829a-83b37c7631a0', 'Somelect Fournisseur', '+222142474', '757485602', 'supplier', false, 'active')
