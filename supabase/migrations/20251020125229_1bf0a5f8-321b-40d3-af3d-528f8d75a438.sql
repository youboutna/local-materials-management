...
-- Helpful indexes
CREATE INDEX IF NOT EXISTS idx_task_assignments_supplier ON public.task_assignments(assigned_supplier_id);
CREATE INDEX IF NOT EXISTS idx_task_assignments_employee ON public.task_assignments(assigned_employee_id);
CREATE INDEX IF NOT EXISTS idx_task_assignments_profile  ON public.task_assignments(assigned_profile_id);