...
CREATE OR REPLACE FUNCTION btp.log_submission_status_change()
RETURNS TRIGGER AS $$
BEGIN
...
ALTER PUBLICATION supabase_realtime ADD TABLE btp.tender_submissions;
ALTER PUBLICATION supabase_realtime ADD TABLE btp.submission_activity_logs;