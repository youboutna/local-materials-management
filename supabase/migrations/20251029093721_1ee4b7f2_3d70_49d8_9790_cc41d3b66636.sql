...
COMMENT ON CONSTRAINT fk_bank_guarantees_project ON btp.bank_guarantees IS 'Links bank guarantees to their associated projects';
COMMENT ON CONSTRAINT fk_payment_blocks_project ON btp.payment_blocks IS 'Links payment blocks to their associated projects';