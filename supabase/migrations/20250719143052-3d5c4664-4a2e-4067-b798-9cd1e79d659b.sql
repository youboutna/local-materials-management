...
DROP POLICY IF EXISTS "Enable insert for authenticated users" ON public.project_phases;
DROP POLICY IF EXISTS "Enable update for authenticated users" ON public.project_phases;
DROP POLICY IF EXISTS "Enable delete for authenticated users" ON public.project_phases;
DROP POLICY IF EXISTS "Enable read access for all users" ON public.project_phases;
