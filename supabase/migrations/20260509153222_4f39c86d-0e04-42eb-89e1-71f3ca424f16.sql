...
CREATE OR REPLACE VIEW public.project_strategy_links AS SELECT * FROM btp.project_strategy_links;
CREATE OR REPLACE VIEW public.project_budget_links AS SELECT * FROM btp.project_budget_links;

GRANT SELECT, INSERT, UPDATE, DELETE ON public.project_strategy_links TO authenticated;
GRANT SELECT, INSERT, UPDATE, DELETE ON public.project_budget_links TO authenticated;
