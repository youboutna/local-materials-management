...
CREATE OR REPLACE VIEW public.boq_alignment_history AS
  SELECT * FROM btp.boq_alignment_history;

GRANT SELECT, INSERT, UPDATE, DELETE ON public.boq_alignment_history TO authenticated;
GRANT ALL ON public.boq_alignment_history TO service_role;
