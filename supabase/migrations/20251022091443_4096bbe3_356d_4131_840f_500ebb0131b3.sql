...
ADD COLUMN inspection_id uuid REFERENCES btp.inspections(id) ON DELETE SET NULL;
...
CREATE INDEX idx_supplier_payment_requests_inspection_id ON btp.supplier_payment_requests(inspection_id);