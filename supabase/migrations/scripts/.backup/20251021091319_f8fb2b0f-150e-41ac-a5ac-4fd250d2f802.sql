...
DROP POLICY IF EXISTS "Users can view inspections for their projects" ON btp.inspections;
DROP POLICY IF EXISTS "Authorized users can create inspections" ON btp.inspections;
DROP POLICY IF EXISTS "Authorized users can update inspections" ON btp.inspections;
DROP POLICY IF EXISTS "Only admins can delete inspections" ON btp.inspections;
...
COMMENT ON POLICY "Authenticated users can view inspections" ON btp.inspections IS 
