...
DROP TABLE IF EXISTS btp.project_stakeholders CASCADE;

-- Create project_stakeholders table with proper structure
CREATE TABLE btp.project_stakeholders (
    ...
    employee_id UUID REFERENCES btp.employees(id) ON DELETE CASCADE,
