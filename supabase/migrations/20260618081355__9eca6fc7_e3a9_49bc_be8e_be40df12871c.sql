...
DROP VIEW IF EXISTS btp.compliance_audit_log;
DROP VIEW IF EXISTS btp.compliance_notes;
DROP VIEW IF EXISTS btp.compliance_documents;
DROP VIEW IF EXISTS btp.compliance_items;

CREATE VIEW btp.compliance_items AS SELECT * FROM btp.compliance_items;
ALTER VIEW btp.compliance_items SET (security_invoker = true);
GRANT SELECT, INSERT, UPDATE, DELETE ON btp.compliance_items TO authenticated;
GRANT ALL ON btp.compliance_items TO service_role;

CREATE VIEW btp.compliance_documents AS SELECT * FROM btp.compliance_documents;
ALTER VIEW btp.compliance_documents SET (security_invoker = true);
GRANT SELECT, INSERT, UPDATE, DELETE ON btp.compliance_documents TO authenticated;
GRANT ALL ON btp.compliance_documents TO service_role;

CREATE VIEW btp.compliance_notes AS SELECT * FROM btp.compliance_notes;
ALTER VIEW btp.compliance_notes SET (security_invoker = true);
GRANT SELECT, INSERT, UPDATE, DELETE ON btp.compliance_notes TO authenticated;
GRANT ALL ON btp.compliance_notes TO service_role;

CREATE VIEW btp.compliance_audit_log AS SELECT * FROM btp.compliance_audit_log;
ALTER VIEW btp.compliance_audit_log SET (security_invoker = true);
GRANT SELECT, INSERT ON btp.compliance_audit_log TO authenticated;
GRANT ALL ON btp.compliance_audit_log TO service_role;
