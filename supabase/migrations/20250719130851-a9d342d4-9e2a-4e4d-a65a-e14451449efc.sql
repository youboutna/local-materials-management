...
CREATE INDEX IF NOT EXISTS idx_projects_responsable ON public.projects(project_responsable_id);
...
CREATE INDEX IF NOT EXISTS idx_material_suppliers_material ON public.material_suppliers(material_id);
CREATE INDEX IF NOT EXISTS idx_material_suppliers_supplier ON public.material_suppliers(supplier_id);
...
CREATE INDEX IF NOT EXISTS idx_project_risks_level ON public.project_risks(risk_level);
...
DROP TRIGGER IF EXISTS update_project_comments_timestamp ON public.project_comments;
CREATE TRIGGER update_project_comments_timestamp
  BEFORE UPDATE ON public.project_comments
  FOR EACH ROW EXECUTE FUNCTION public.update_timestamp();

DROP TRIGGER IF EXISTS update_project_milestones_timestamp ON public.project_milestones;
CREATE TRIGGER update_project_milestones_timestamp
  BEFORE UPDATE ON public.project_milestones
  FOR EACH ROW EXECUTE FUNCTION public.update_timestamp();

DROP TRIGGER IF EXISTS update_project_risks_timestamp ON public.project_risks;
