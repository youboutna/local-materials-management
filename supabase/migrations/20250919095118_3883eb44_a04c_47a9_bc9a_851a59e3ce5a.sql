...
CREATE POLICY "Allow public access to tender_steps" ON btp.tender_steps FOR ALL USING (true);
...
CREATE POLICY "Allow public access to tender_step_documents" ON btp.tender_step_documents FOR ALL USING (true);