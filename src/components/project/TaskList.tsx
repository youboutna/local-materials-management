...
const TaskList: React.FC<TaskListProps> = ({ tasks, projectId }) => {
  ...
  const getStatusColor = (status: string) => {
    switch (status) {
      ...
      case TaskStatus.IN_PROGRESS: return 'bg-primary/10 text-primary border-primary/30';
      case TaskStatus.BLOCKED: return 'bg-destructive/10 text-destructive border-destructive/30';
      case TaskStatus.PENDING: return 'bg-warning/10 text-warning border-warning/30';
