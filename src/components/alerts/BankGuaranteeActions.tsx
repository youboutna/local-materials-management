...
import { createBankGuaranteeAction, getBankGuaranteeActions } from '@/services/bankGuaranteeActionService';
import UserSelector from '@/components/selectors/UserSelector';
import { Calendar, Users, Phone, Mail, MessageSquare, FileText, AlertTriangle } from 'lucide-react';

interface BankGuaranteeActionsProps {
...
const BankGuaranteeActions: React.FC<BankGuaranteeActionsProps> = ({
  bankGuaranteeId,
  projectId,
  contractorId,
  delayData
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await createBankGuaranteeAction({
        ...
        metadata: {
          delayData,
          createdFrom: 'bank_guarantee_monitor'
        }
      });
    ...
    <Card className="w-full">
      <CardHeader>
        <CardTitle className="flex items-center gap-2">
          ...
          Actions de Contrôle - Garantie Bancaire
        </CardTitle>
      </CardHeader>
      <CardContent>
        ...
        <div className="mt-8 pt-6 border-t">
          ...
          <div className="space-y-2">
            {getBankGuaranteeActions(bankGuaranteeId).map((action) => {
...
export default BankGuaranteeActions;