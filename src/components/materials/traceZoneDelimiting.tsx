...
interface TraceZoneDelimitingProps {
  value?: Point[];
  onChange: (points: Point[]) => void;
  title?: string;
}

const TraceZoneDelimiting: React.FC<TraceZoneDelimitingProps> = ({
  value = [],
  onChange,
  title = "Délimitation de zone"
}) => {
...
export default TraceZoneDelimiting;
