  ...
  return (
    ...
    >
      <div className="container mx-auto px-4">
        <div className="flex flex-wrap items-center justify-between min-h-16 gap-4">
          <Link to="/" className="flex items-center space-x-2.5">
            ...
            <span className="text-xl hidden max-sm:block font-bold text-adrar-900 font-serif">
              Construct
            </span>
          </Link>

          <div className="hidden md:flex md:flex-wrap items-center space-x-3">
            {navItems.map((item) => (
              <Link
                key={item.name}
                to={item.href}
