    ...
    () => DocumentHeaderService.merge(
      {
        ...
        sender: {
          ...
          taxId: effectiveParties.senderTaxId ?? null,
        },
        recipients: [
          { name: effectiveParties.recipientName ?? '', email: effectiveParties.recipientEmail ?? null, taxId: effectiveParties.recipientTaxId ?? null },
