...
import { createInspectionAction, getInspectionActions } from '@/services/inspectionActionService';
import UserSelector from '@/components/selectors/UserSelector';
import { Calendar, Users, Phone, Mail, MessageSquare, FileText, Search } from 'lucide-react';
...
const InspectionActions: React.FC<InspectionActionsProps> = ({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await createInspectionAction({
        ...
        metadata: {
          inspectionStatus,
          createdFrom: 'inspection_monitor'
        }
      });
  ...
  const getActionIcon = (type: string) => {
    ...
    return actionType ? actionType.icon : Search;
  };
    ...
    <Card className="w-full">
      <CardHeader>
        <CardTitle className="flex items-center gap-2">
          ...
          Actions de Contrôle - Inspection
        </CardTitle>
      </CardHeader>
      <CardContent>
        ...
        <div className="mt-8 pt-6 border-t">
          ...
          <div className="space-y-2">
            {getInspectionActions(inspectionId).map((action) => {
