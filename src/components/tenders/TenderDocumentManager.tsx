...
import { TenderDocumentWithDetails, TenderDocumentCategory, TENDER_DOCUMENT_LABELS, TENDER_CATEGORY_LABELS, TenderDocumentSubcategory, ADMINISTRATIVE_SUBCATEGORY_GROUPS } from '@/dtos/entities/TenderDTO';
