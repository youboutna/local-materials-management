...
import { CalendarDays, Users, Building2, DollarSign, MapPin } from 'lucide-react';
    ...
    <div className="space-y-6">
      ...
      <div className="flex justify-between items-center">
        <p className="text-sm text-muted-foreground">
          {totalItems} projet{totalItems > 1 ? 's' : ''} trouvé{totalItems > 1 ? 's' : ''}
        </p>
        {totalPages > 1 && (
          <p className="text-sm text-muted-foreground">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {projects.map((project) => (
          <Card key={project.id} className="hover:shadow-lg transition-all duration-200 transform hover:-translate-y-1">
            <CardContent className="p-6">
              <div className="space-y-4">
