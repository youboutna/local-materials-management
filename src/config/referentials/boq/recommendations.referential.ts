/**
 * BOQ recommendations referential — recommandations métier par type d'ouvrage.
 * Consommé par la saisie manuelle DQE (BoqWorkspace) et le calculateur de métré.
 * Aucune valeur métier codée en dur dans l'UI : tout passe par ce référentiel.
 */
