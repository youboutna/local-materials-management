...
export class PhaseTransformer {
  ...
  static toDB(phase: Partial<Phase> & Record<string, any>): Record<string, unknown> {
    ...
    set('start_date', phase.startDate instanceof Date ? phase.startDate.toISOString() : phase.startDate);
    set('end_date', phase.endDate instanceof Date ? phase.endDate.toISOString() : phase.endDate);
