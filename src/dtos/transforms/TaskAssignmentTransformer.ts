/**
 * TaskAssignment Transformer — SOURCE UNIQUE
...
export class TaskAssignmentTransformer {
  ...
  // ============= DTO → Entity =============
  static toEntity(dto: CreateTaskAssignmentDTO | TaskAssignmentDTO): TaskAssignment {
    const source = dto as TaskAssignmentDTO & CreateTaskAssignmentDTO;
