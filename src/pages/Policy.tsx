        ...
        <div className="container mx-auto px-4">
          <div className="bg-white rounded-xl shadow-elegant p-8">
            ...
            <div className="prose prose-adrar max-w-none">
              <p className="text-lg mb-6">{t("policy.last_update")}</p>

              <h2 className="text-xl font-semibold mb-4">
                {t("policy.section1.title")}
              </h2>
              <p className="mb-4">{t("policy.section1.text")}</p>

              <h2 className="text-xl font-semibold mb-4">
                {t("policy.section2.title")}
              </h2>
              <p className="mb-4">{t("policy.section2.text")}</p>
              ...
              <p className="mb-4">{t("policy.section3.text")}</p>
              <ul className="list-disc pl-6 mb-4">
              ...
              <p className="mb-4">{t("policy.section4.text")}</p>
              <ul className="list-disc pl-6 mb-4">
              ...
              <p className="mb-4">{t("policy.section5.text")}</p>

              <h2 className="text-xl font-semibold mb-4">
                {t("policy.section6.title")}
              </h2>
              <p className="mb-4">{t("policy.section6.text")}</p>
              <ul className="list-disc pl-6 mb-4">
              ...
              <p className="mb-4">{t("policy.section7.text")}</p>

              <h2 className="text-xl font-semibold mb-4">
                {t("policy.section8.title")}
              </h2>
              <p className="mb-4">{t("policy.section8.text")}</p>
            </div>
          </div>
        </div>
      </main>
