...
export const translations = {
    fr: {
        'dqe.stage.need': 'Expression de besoin (DQE)',
        'dqe.stage.tender_publication': 'Publication appel d’offres',
        'dqe.stage.quote': 'Devis',
        'dqe.stage.contract': 'Contrat',
        'dqe.stage.progress_statement': 'Décompte',
        'dqe.stage.technical_validation': 'Validation technique',
        'dqe.stage.final_invoice': 'Facture finale',
        'dqe.reverse.reopen': 'Réouvrir (brouillon)',
        'dqe.reverse.unpublish': 'Annuler la publication',
        'dqe.reverse.review': 'Remettre en analyse',
        'dqe.reverse.return_received': 'Revenir à « reçu »',
        'dqe.reverse.contract_review': 'Revenir au contrat reçu',
        'dqe.reverse.statement_review': 'Remettre le décompte en demande',
        'dqe.reverse.invoice_review': 'Revenir à la facture émise',
        'dqe.reverse.hint': 'Cliquer pour revenir à cette étape',
        'dqe.reverse.confirm': 'Les lignes du document repasseront en édition.',
        'dqe.reverse.done': 'Document déverrouillé',
        'dqe.reverse.failed': 'Retour arrière impossible',
        'dqe.reverse.unavailable': 'Retour arrière indisponible',
        'dqe.reverse.unavailable_hint': 'Statut ou rôle insuffisant pour déverrouiller ce document.',
        'dqe.header.reference': 'Référence',
        'dqe.header.issue_date': 'Date d’émission',
        'dqe.header.currency': 'Devise',
        'dqe.header.validity_days': 'Validité (jours)',
        'dqe.header.extra_recipients': 'Destinataires additionnels',
        'dqe.header.extra_recipients_hint': 'Aucun destinataire additionnel.',
        'dqe.header.title': 'Titre (Title)',
        'dqe.header.type_code': 'Type code',
        'dqe.header.error.title': 'En-tête incomplet',
        'dqe.header.error.title_required': 'Le titre est obligatoire',
        'dqe.header.error.type_code_required': 'Le type code est obligatoire',
        'dqe.header.error.title_typecode': 'Veuillez renseigner le titre et le type code avant de continuer.',
        'dqe.header.error.sender': 'Émetteur manquant',
        'dqe.header.error.recipient': 'Aucun destinataire sélectionné',
        'dqe.header.error.currency': 'Devise manquante',
        'dqe.header.error.type_code': 'TypeCode Factur-X manquant',
        'dqe.header.error.validity': 'Validité invalide',
        'dqe.header.error.issue_date': 'Date d’émission manquante',
        'dqe.header.error.vat': 'Taux de TVA manquant sur au moins une ligne',
        'dqe.vat.level_global': 'TVA globale',
        'dqe.vat.level_category': 'TVA par catégorie',
        'dqe.vat.level_line': 'TVA de la ligne',
        'dqe.labour.day': 'Homme·jour',
        'dqe.labour.month': 'Homme·mois',
        'dqe.labour.lump_sum': 'Forfait',
        common: {
            yes: "Oui",
            no: "Non",
            cancel: "Annuler",
        ...
        users: {
            ...
            confirm_delete_named: "Supprimer {name} ? Cette action est irréversible.",
            delete_nothing_deleted: "Aucune ligne supprimée côté serveur.",
...
// Pour les Bureaux d'Études
    ...
    ar: {
        'dqe.stage.need': 'التعبير عن الحاجة',
        'dqe.stage.tender_publication': 'نشر طلب العروض',
        'dqe.stage.quote': 'عرض سعر',
        'dqe.stage.contract': 'عقد',
        'dqe.stage.progress_statement': 'كشف مرحلي',
        'dqe.stage.technical_validation': 'المصادقة الفنية',
        'dqe.stage.final_invoice': 'الفاتورة النهائية',
        'dqe.reverse.reopen': 'إعادة الفتح (مسودة)',
        'dqe.reverse.unpublish': 'إلغاء النشر',
        'dqe.reverse.review': 'إعادة الدراسة',
        'dqe.reverse.return_received': 'العودة إلى مستلم',
        'dqe.reverse.contract_review': 'العودة إلى العقد المستلم',
        'dqe.reverse.statement_review': 'إعادة الكشف إلى الطلب',
        'dqe.reverse.invoice_review': 'العودة إلى الفاتورة الصادرة',
        'dqe.reverse.hint': 'انقر للعودة إلى هذه المرحلة',
        'dqe.reverse.confirm': 'ستعود بنود الوثيقة إلى وضع التحرير.',
        'dqe.reverse.done': 'تم فتح الوثيقة',
        'dqe.reverse.failed': 'تعذر الرجوع',
        'dqe.reverse.unavailable': 'الرجوع غير متاح',
        'dqe.reverse.unavailable_hint': 'الحالة أو الدور لا يسمح بفتح هذه الوثيقة.',
        'dqe.header.reference': 'المرجع',
        'dqe.header.issue_date': 'تاريخ الإصدار',
        'dqe.header.currency': 'العملة',
        'dqe.header.validity_days': 'مدة الصلاحية (أيام)',
        'dqe.header.extra_recipients': 'مستلمون إضافيون',
        'dqe.header.extra_recipients_hint': 'لا يوجد مستلم إضافي.',
        'dqe.header.title': 'العنوان',
        'dqe.header.type_code': 'رمز النوع',
        'dqe.header.error.title': 'ترويسة غير مكتملة',
        'dqe.header.error.title_required': 'العنوان مطلوب',
        'dqe.header.error.type_code_required': 'رمز النوع مطلوب',
        'dqe.header.error.title_typecode': 'يرجى إدخال العنوان ورمز النوع للمتابعة.',
        'dqe.header.error.sender': 'المرسل مفقود',
        'dqe.header.error.recipient': 'لم يتم تحديد مستلم',
        'dqe.header.error.currency': 'العملة مفقودة',
        'dqe.header.error.type_code': 'رمز Factur-X مفقود',
        'dqe.header.error.validity': 'مدة صلاحية غير صحيحة',
        'dqe.header.error.issue_date': 'تاريخ الإصدار مفقود',
        'dqe.header.error.vat': 'نسبة الضريبة مفقودة في بند واحد على الأقل',
        'dqe.vat.level_global': 'الضريبة العامة',
        'dqe.vat.level_category': 'الضريبة حسب الفئة',
        'dqe.vat.level_line': 'ضريبة البند',
        'dqe.labour.day': 'رجل/يوم',
        'dqe.labour.month': 'رجل/شهر',
        'dqe.labour.lump_sum': 'جزافي',
        common: {
            yes: "نعم",
            no: "لا",
            cancel: "إلغاء",
        ...
        users: {
            ...
            confirm_delete_named: "حذف {name}؟ لا يمكن التراجع عن هذا الإجراء.",
            delete_nothing_deleted: "لم يتم حذف أي سطر على الخادم.",
...
procurement_features: {
    ...
    en: {
        'dqe.stage.need': 'Statement of needs (BoQ)',
        'dqe.stage.tender_publication': 'Tender publication',
        'dqe.stage.quote': 'Quotation',
        'dqe.stage.contract': 'Contract',
        'dqe.stage.progress_statement': 'Progress statement',
        'dqe.stage.technical_validation': 'Technical validation',
        'dqe.stage.final_invoice': 'Final invoice',
        'dqe.reverse.reopen': 'Reopen (draft)',
        'dqe.reverse.unpublish': 'Cancel publication',
        'dqe.reverse.review': 'Return to review',
        'dqe.reverse.return_received': 'Back to received',
        'dqe.reverse.contract_review': 'Back to received contract',
        'dqe.reverse.statement_review': 'Return statement to requested',
        'dqe.reverse.invoice_review': 'Back to issued invoice',
        'dqe.reverse.hint': 'Click to step back to this stage',
        'dqe.reverse.confirm': 'Document lines will become editable again.',
        'dqe.reverse.done': 'Document unlocked',
        'dqe.reverse.failed': 'Cannot step back',
        'dqe.reverse.unavailable': 'Step back unavailable',
        'dqe.reverse.unavailable_hint': 'Status or role does not allow unlocking this document.',
        'dqe.header.reference': 'Reference',
        'dqe.header.issue_date': 'Issue date',
        'dqe.header.currency': 'Currency',
        'dqe.header.validity_days': 'Validity (days)',
        'dqe.header.extra_recipients': 'Additional recipients',
        'dqe.header.extra_recipients_hint': 'No additional recipient.',
        'dqe.header.title': 'Title',
        'dqe.header.type_code': 'Type code',
        'dqe.header.error.title': 'Incomplete header',
        'dqe.header.error.title_required': 'Title is required',
        'dqe.header.error.type_code_required': 'Type code is required',
        'dqe.header.error.title_typecode': 'Please fill in the title and type code before continuing.',
        'dqe.header.error.sender': 'Missing sender',
        'dqe.header.error.recipient': 'No recipient selected',
        'dqe.header.error.currency': 'Missing currency',
        'dqe.header.error.type_code': 'Missing Factur-X type code',
        'dqe.header.error.validity': 'Invalid validity',
        'dqe.header.error.issue_date': 'Missing issue date',
        'dqe.header.error.vat': 'Missing VAT rate on at least one line',
        'dqe.vat.level_global': 'Global VAT',
        'dqe.vat.level_category': 'VAT by category',
        'dqe.vat.level_line': 'Line VAT',
        'dqe.labour.day': 'Man·day',
        'dqe.labour.month': 'Man·month',
        'dqe.labour.lump_sum': 'Lump sum',
        common: {
            yes: "Yes",
            no: "No",
            cancel: "Cancel",
        ...
        users: {
            ...
            delete_nothing_deleted: "No line was deleted on the server.",
...
const PHASE_STRUCTURE_KEYS = {
    fr: {
        ...
        'dqe.navigation.module': 'Expression de besoin (DQE)',
        'dqe.navigation.project_scope': 'DQE rattaché au projet courant',
        'dqe.navigation.workspace': 'Document courant',
        ...
        'dqe.action.view': 'Consulter',
        'dqe.action.edit': 'Modifier',
        'dqe.action.save': 'Enregistrer le DQE',
        'dqe.action.takeoff': 'Calcul métré',
        'dqe.action.add': 'Ajouter',
        'dqe.action.clear_draft': 'Vider le brouillon',
        'dqe.action.align_planning': 'Aligner à la planification',
        'dqe.action.sign': 'Signer',
        'dqe.action.signed': 'Signé',
        'dqe.action.validate_gate': 'Valider l’injection',
        'dqe.action.procurement_chain': 'Chaîne marchés',
        'dqe.action.facturx': 'Factur-X',
        'dqe.action.email': 'Envoyer par email',
        'dqe.action.transform_to': 'Transformer en',
        'dqe.save_success': 'DQE enregistré',
        'dqe.save_hint_no_pending': 'Aucune modification à enregistrer',
        'dqe.clear_draft.confirm': 'Les lignes non enregistrées seront retirées du brouillon.',
        'dqe.doc_status.new': 'Nouveau',
        'dqe.doc_status.to_save': 'À enregistrer',
        'dqe.doc_status.validated': 'Persisté',
        'dqe.locked_signed': 'Document signé',
        'dqe.locked_transmitted': 'Document transmis',
        'dqe.referential.project': 'Référentiel projet',
        'dqe.referential.project_default': 'Référentiel du projet',
        'dqe.referential.enrich': 'Utiliser',
        'dqe.referential.hint': 'Le référentiel du projet est sélectionné par défaut ; le changement ne modifie que ce document.',
        'dqe.responsible.placeholder': 'Responsable par défaut',
        'dqe.responsible.none': 'Aucun responsable par défaut',
        'dqe.fiscal.vat': 'TVA',
        'dqe.fiscal.ht': 'HT',
        'dqe.actions.document_menu': 'Document',
        'dqe.actions.parties_menu': 'Parties',
        'dqe.actions.workflow_menu': 'Workflow',
        'dqe.actions.planning_menu': 'Planification',
        'dqe.action.generate_xml': 'Générer XML (Factur-X)',
        'dqe.action.download_pdf': 'Télécharger PDF',
        'dqe.action.download_xml': 'Télécharger XML',
        'dqe.action.history': 'Historique',
        'dqe.history.description': 'Jalons franchis du cycle de vie documentaire et signature.',
        'dqe.parties.edit_title': 'Émetteur / destinataire',
        'dqe.parties.edit_hint': 'Ces informations alimentent le PDF et la facture structurée.',
        'dqe.parties.locked_hint': 'Document verrouillé : les parties ne sont plus modifiables.',
        'dqe.parties.locked_badge': 'Verrouillé',
        'dqe.parties.sender': 'Émetteur',
        'dqe.parties.recipient': 'Destinataire',
        'dqe.parties.search': 'Rechercher',
        'dqe.parties.no_result': 'Aucun résultat',
        'dqe.parties.sender_placeholder': 'Sélectionner ou saisir l’émetteur',
        'dqe.parties.recipient_placeholder': 'Sélectionner ou saisir le destinataire',
        'dqe.parties.sender_address': 'Adresse émetteur',
        'dqe.parties.sender_phone': 'Téléphone émetteur',
        'dqe.parties.sender_email': 'Email émetteur',
        'dqe.parties.recipient_email': 'Email destinataire',
        'dqe.gate.validated': 'Injection validée',
        'dqe.gate.validation_required': 'Validation requise',
        'dqe.badge.project_ref': 'Projet',
        'dqe.badge.planning_fed': 'Planification alimentée',
        'dqe.badge.tender_published': 'Appel d’offres publié',
        'dqe.badge.chain_issues': 'Chaîne à resynchroniser',
        'dqe.lifecycle.status_label': 'Statut',
        'dqe.lifecycle.billed_progress': 'Avancement facturé',
        'dqe.lifecycle.possible_statuses_tooltip': 'Statuts possibles',
        'dqe.lifecycle.possible_statuses_label': 'Statuts possibles',
        'dqe.transform.blocked': 'Transformation bloquée',
    },
    ar: {
