...
export const translations = {
    fr: {
        ...
        dashboard: {
            ...
            management_tabs: {
                ...
                monitoring: "Monitoring",
                    alerts: {
                        ...
                        inspection_overdue_desc_prefix: "Inspection non réalisée depuis",
                        days: "jours",
                        none: "Aucune alerte trouvée",
                        acknowledge: "Acquitter",
                        guarantee_expiring: "Garantie Bancaire Expirante",
                        guarantee_expiring_desc_prefix: "Garantie de",
                        guarantee_expiring_desc_suffix: "expire dans",
                        load_error: "Échec du chargement des alertes",
            ...
            active_projects: "Projets actifs",
            status_overview: "Vue d'ensemble des statuts",
            active_projects_label: "projets actifs",
            total_budget: "Budget total",
            financial_resources: "Ressources financières",
            team: "Équipe",
            project_staff: "Personnel du projet",
            members: "membres",
            materials: "Matériaux",
            available_resources: "Ressources disponibles",
            types: "types",
        ...
        projects: {
            ...
            import: {
                ...
                modeCreate: 'Créer ou mettre à jour',
                modeUpdate: 'Mise à jour complète',
                modePatch: 'Mise à jour partielle',
                modeCreateDesc: 'Crée les nouveaux projets et met à jour ceux qui existent selon leur référence métier.',
                modeUpdateDesc: 'Remplace les données des projets existants correspondant à leur référence métier.',
                modePatchDesc: 'Met à jour uniquement les champs fournis dans le fichier.',
...
/**
 * T37 — Clés d'interface complétées en arabe et en anglais.
 * Format à plat (`a.b.c`) : plus lisible pour un rattrapage de couverture,
 * expansé puis fusionné sans écraser les clés déjà présentes.
 */
const AR_ADDITIONS_FLAT: Record<string, string> = {
    'common.refresh': 'تحديث',
    'supplier_tender.title': 'بوابة الموردين - العطاءات',
    'supplier_tender.subtitle': 'استعرض العطاءات وقدّم عروضك',
    'supplier_tender.access_granted_for': 'تم منح الوصول لـ:',
    'supplier_tender.tabs.browse': 'استعراض',
    'supplier_tender.tabs.documents': 'الوثائق المشتركة',
    'supplier_tender.tabs.submit': 'تقديم عرض',
    'supplier_tender.empty.no_tenders': 'لا يوجد عطاء متاح',
    'supplier_tender.empty.select_tender': 'اختر عطاءً',
    'supplier_tender.actions.submit': 'تقديم عرض',
    'supplier_tender.actions.download': 'تحميل',
    'supplier_tender.submit_success': 'تم إرسال العرض بنجاح',
    'supplier_tender.submit_success_desc': 'تم تقديم ملف ترشحكم. أُرسلت رسالة تأكيد تتضمن رمزكم السري.',
    'supplier_tender.project_label': 'المشروع',
    'supplier_tender.location_label': 'الموقع',
    'supplier_tender.launched_on': 'تاريخ الإطلاق',
    'supplier_tender.deadline_label': 'الأجل',
    'supplier_tender.criteria_intro': 'تُعرض العطاءات فقط إذا استجابت للمعايير التالية:',
    'supplier_tender.criteria.status': 'الحالة: منشور',
    'supplier_tender.criteria.phase': 'المرحلة: المرحلة 2 (طلب العروض)',
    'supplier_tender.criteria.deadline': 'الأجل: في المستقبل',
    'supplier_tender.errors.invalid_deadline': 'أجل تقديم العروض غير صالح',
    'supplier_tender.errors.deadline_passed': 'انقضى أجل تقديم العروض',
    'supplier_tender.errors.submit_failed': 'خطأ أثناء تقديم الملف.',
    'supplier_tender.errors.already_submitted': 'لقد قدّمتم ملفًا لهذا العطاء مسبقًا.',
    'nav.supplier_access': 'وصول المورد',
    'nav.evaluation_access': 'وصول التقييم',
    'nav.access_secure': 'وصول آمن',
    'tenders.supplierSecure.enter_code': 'أدخل رمز الوصول',
    'tenders.supplierSecure.enter_code_desc': 'أدخل الرمز السري المرسل مع العطاء.',
    'tenders.supplierSecure.code_placeholder': 'رمز الوصول',
    'tenders.supplierSecure.validate': 'تحقق',
    'tenders.supplierSecure.access_granted_desc': 'تم منح الوصول إلى العطاء.',
    'tenders.supplierSecure.security_notice': 'السرية',
    'tenders.supplierSecure.security_notice_desc': 'هذا الرمز شخصي ولا يجوز مشاركته.',
    'users.total': 'إجمالي عدد المستخدمين',
    'users.cancel': 'إلغاء',
    'users.inactive': 'مستخدمون غير نشطين',
    'users.created_success': 'تم إنشاء المستخدم بنجاح.',
    'users.updated_success': 'تم تحديث المستخدم بنجاح.',
    'dashboard.management_tabs.alerts.total': 'إجمالي التنبيهات',
    'dashboard.management_tabs.alerts.critical': 'حرجة',
    'dashboard.management_tabs.alerts.high': 'مرتفعة',
    'dashboard.management_tabs.alerts.medium': 'متوسطة',
    'dashboard.management_tabs.alerts.low': 'منخفضة',
    'dashboard.management_tabs.alerts.tabs.all': 'الكل',
    'dashboard.management_tabs.alerts.tabs.delay': 'التأخيرات',
    'dashboard.management_tabs.alerts.tabs.payment': 'المدفوعات',
    'dashboard.management_tabs.alerts.tabs.inspection': 'التفتيشات',
    'dashboard.management_tabs.alerts.tabs.guarantee': 'الضمانات',
    'dashboard.management_tabs.alerts.none': 'لا توجد تنبيهات',
    'dashboard.management_tabs.alerts.acknowledge': 'إقرار',
    'dashboard.management_tabs.alerts.acknowledge_success': 'تم الإقرار بالتنبيه',
    'dashboard.management_tabs.alerts.acknowledge_description': 'تم وسم التنبيه كمُقَر به',
    'bank_guarantee.load_delays_error': 'تعذر تحميل تأخيرات المشروع',
    'bank_guarantee.not_found_for_project': 'لا يوجد ضمان بنكي لهذا المشروع',
    'bank_guarantee.bank_notified_prefix': 'تم إخطار البنك بالتأخير في',
    'bank_guarantee.internal_notifications_sent': 'إخطارات داخلية مُرسلة',
    'bank_guarantee.notification_send_failed': 'فشل إرسال الإخطار البنكي',
    'bank_guarantee.project_not_found': 'المشروع غير موجود',
    'bank_guarantee.critical_projects': 'مشروع (مشاريع) في تأخير حرج',
    'bank_guarantee.critical_alerts_desc': 'تأخيرات تتجاوز الحدود التعاقدية. مطلوب إجراء فوري.',
    'bank_guarantee.no_critical_delays_title': 'لا تأخير حرج',
    'bank_guarantee.no_critical_delays_desc': 'جميع المشاريع تحترم الآجال التعاقدية.',
    'bank_guarantee.notify_sending': 'جارٍ الإرسال...',
    'bank_guarantee.notify_bank': 'إخطار البنك',
    'bank_guarantee.view_project': 'عرض المشروع',
    'bank_guarantee.delay_label': 'التأخير',
    'bank_guarantee.days_label': 'أيام',
    'bank_guarantee.contractor_label': 'المقاول',
    'bank_guarantee.planned_date_label': 'التاريخ المقرر',
    'bank_guarantee.milestones_missed_label': 'مراحل غير مُنجزة',
    'bank_guarantee.escalation_thresholds_title': 'حدود التصعيد',
    'bank_guarantee.delay_percentage_suffix': 'من التأخير',
    'bank_guarantee.severity_labels.delay_alert': 'تنبيه تأخير',
    'bank_guarantee.severity_labels.bank_notification': 'إخطار بنكي',
    'bank_guarantee.severity_labels.guarantee_trigger': 'تنفيذ الضمان',
    'bank_guarantee.escalation.legal': 'تصعيد قانوني',
    'bank_guarantee.actions.task_assignment_title': 'إدارة تأخير المشروع',
    'bank_guarantee.actions.task_assignment_msg_prefix': 'يُرجى معالجة تأخير',
    'bank_guarantee.actions.hierarchy_notification_title': 'تنبيه تأخير حرج',
    'bank_guarantee.actions.hierarchy_notification_msg_prefix': 'المشروع',
    'bank_guarantee.actions.sms_title': 'رسالة نصية بشأن تأخير المشروع',
    'bank_guarantee.actions.sms_msg_prefix': 'رسالة: تأخير',
    'bank_guarantee.actions.call_title': 'مكالمة بشأن تأخير المشروع',
    'bank_guarantee.actions.call_msg_prefix': 'مكالمة بشأن تأخير المشروع',
    'bank_guarantee.actions.email_title': 'بريد بشأن تأخير المشروع',
    'bank_guarantee.actions.email_msg_prefix': 'بريد إلكتروني بشأن تأخير المشروع',
    'bank_guarantee.actions.mail_title': 'مراسلة بشأن تأخير المشروع',
    'bank_guarantee.actions.mail_msg_prefix': 'مراسلة بشأن تأخير المشروع',
    'bank_guarantee.unknown_action_type': 'نوع الإجراء غير معروف',
    'bank_guarantee.action_created_success': 'تم إنشاء {title} بنجاح',
    'bank_guarantee.alerts_title': 'تنبيهات الضمانات البنكية',
    'bank_guarantee.alert_acknowledged': 'تم الإقرار بالتنبيه',
    'bank_guarantee.alert_acknowledge_error': 'تعذر الإقرار بالتنبيه',
    'bank_guarantee.alert_resolved': 'تم حل التنبيه',
    'bank_guarantee.alert_resolve_error': 'تعذر حل التنبيه',
    'bank_guarantee.delay_percent_prefix': 'التأخير',
    'documents.employee.updated_successfully': 'تم تحديث الوثيقة بنجاح.',
    'projects.import.importMode': 'وضع الاستيراد',
    'projects.import.modeCreate': 'إنشاء أو تحديث',
    'projects.import.modeUpdate': 'تحديث كامل',
    'projects.import.modePatch': 'تحديث جزئي',
    'projects.import.modeCreateDesc': 'ينشئ المشاريع الجديدة ويحدّث الموجودة حسب مرجعها.',
    'projects.import.modeUpdateDesc': 'يستبدل بيانات المشاريع الموجودة المطابقة لمرجعها.',
    'projects.import.modePatchDesc': 'يحدّث فقط الحقول الموجودة في الملف.',
    'projects.import.projectsCreated': 'مشروع (مشاريع) مُنشأة',
    'projects.import.projectsUpdated': 'مشروع (مشاريع) مُحدّثة',
    'projects.view_details': 'عرض التفاصيل',
    'materials.documents.title': 'وثائق المادة',
    'materials.documents.subtitle': 'إدارة كل وثائق المادة (فواتير، شهادات، دليل الاستخدام)',
    'materials.documents.upload_title': 'تحميل الوثائق',
    'materials.documents.upload_description': 'حمّل الوثائق التي ستُربط بهذه المادة',
    'materials.documents.types.invoice': 'فاتورة',
    'materials.documents.types.warranty': 'ضمان',
    'materials.documents.types.certificate': 'شهادة',
    'materials.documents.types.manual': 'دليل',
    'materials.documents.invoice_desc': 'إثباتات الشراء والتسليم',
    'materials.documents.certificate_desc': 'الجودة، المطابقة، السلامة',
    'materials.documents.manual_desc': 'تعليمات الاستخدام',
    'materials.documents.warranty_desc': 'وثائق الضمان',
    'materials.documents.save_reminder_title': 'حفظ تلقائي',
    'materials.documents.save_reminder_text': 'ستُربط الوثائق تلقائيًا بالمادة بعد إنشائها.',
    'materials.none_selected': 'لا يوجد تحديد',
    'materials.last_updated': 'آخر تحديث',
    'materials.sources_title': 'مصادر السعر',
    'materials.no_sources': 'لا يوجد مصدر سعر',
    'materials.add_sources_hint': 'أضف مصدرًا لتتبع أصل سعر الوحدة.',
    'materials.updated_success': 'تم تحديث المادة.',
    'inspection_monitoring.title': 'متابعة التفتيشات',
    'inspection_monitoring.subtitle': 'تخطيط وتنفيذ ومطابقة التفتيشات',
};

const EN_ADDITIONS_FLAT: Record<string, string> = {
    'common.refresh': 'Refresh',
    'supplier_tender.title': 'Supplier portal - Tenders',
    'supplier_tender.subtitle': 'Browse tenders and submit bids',
    'supplier_tender.access_granted_for': 'Access granted for:',
    'supplier_tender.tabs.browse': 'Browse',
    'supplier_tender.tabs.documents': 'Shared documents',
    'supplier_tender.tabs.submit': 'Submit a bid',
    'supplier_tender.empty.no_tenders': 'No tender available',
    'supplier_tender.empty.select_tender': 'Select a tender',
    'supplier_tender.actions.submit': 'Submit a bid',
    'supplier_tender.actions.download': 'Download',
    'supplier_tender.submit_success': 'Bid submitted successfully',
    'supplier_tender.submit_success_desc': 'Your application has been submitted. A confirmation email with your secret code has been sent.',
    'supplier_tender.project_label': 'Project',
    'supplier_tender.location_label': 'Location',
    'supplier_tender.launched_on': 'Launched on',
    'supplier_tender.deadline_label': 'Deadline',
    'supplier_tender.criteria_intro': 'Tenders are listed only when they meet the following criteria:',
    'supplier_tender.criteria.status': 'Status: Published',
    'supplier_tender.criteria.phase': 'Phase: Phase 2 (Call for bids)',
    'supplier_tender.criteria.deadline': 'Deadline: in the future',
    'supplier_tender.errors.invalid_deadline': 'Invalid submission deadline',
    'supplier_tender.errors.deadline_passed': 'The submission deadline has passed',
    'supplier_tender.errors.submit_failed': 'Error while submitting the application.',
    'supplier_tender.errors.already_submitted': 'You have already submitted an application for this tender.',
    'nav.supplier_access': 'Supplier access',
    'nav.evaluation_access': 'Evaluation access',
    'nav.access_secure': 'Secure access',
    'tenders.supplierSecure.enter_code': 'Enter the access code',
    'tenders.supplierSecure.enter_code_desc': 'Enter the secret code sent with the tender.',
    'tenders.supplierSecure.code_placeholder': 'Access code',
    'tenders.supplierSecure.validate': 'Validate',
    'tenders.supplierSecure.access_granted_desc': 'Access granted to the tender.',
    'tenders.supplierSecure.security_notice': 'Confidentiality',
    'tenders.supplierSecure.security_notice_desc': 'This code is personal and must not be shared.',
    ...
    'dashboard.management_tabs.alerts.total': 'Total alerts',
    'dashboard.management_tabs.alerts.critical': 'Critical',
    'dashboard.management_tabs.alerts.high': 'High',
    'dashboard.management_tabs.alerts.medium': 'Medium',
    'dashboard.management_tabs.alerts.low': 'Low',
    'dashboard.management_tabs.alerts.tabs.all': 'All',
    'dashboard.management_tabs.alerts.tabs.delay': 'Delays',
    'dashboard.management_tabs.alerts.tabs.payment': 'Payments',
    'dashboard.management_tabs.alerts.tabs.inspection': 'Inspections',
    'dashboard.management_tabs.alerts.tabs.guarantee': 'Guarantees',
    'dashboard.management_tabs.alerts.none': 'No alert found',
    'dashboard.management_tabs.alerts.acknowledge': 'Acknowledge',
    'dashboard.management_tabs.alerts.acknowledge_success': 'Alert acknowledged',
    'dashboard.management_tabs.alerts.acknowledge_description': 'The alert has been marked as acknowledged',
    'bank_guarantee.load_delays_error': 'Unable to load project delays',
    'bank_guarantee.not_found_for_project': 'No bank guarantee found for this project',
    'bank_guarantee.bank_notified_prefix': 'The bank has been notified of the delay on',
    'bank_guarantee.internal_notifications_sent': 'internal notifications sent',
    'bank_guarantee.notification_send_failed': 'Failed to send the bank notification',
    'bank_guarantee.project_not_found': 'Project not found',
    'bank_guarantee.critical_projects': 'project(s) critically delayed',
    'bank_guarantee.critical_alerts_desc': 'Delays exceed contractual thresholds. Immediate action required.',
    'bank_guarantee.no_critical_delays_title': 'No critical delay detected',
    'bank_guarantee.no_critical_delays_desc': 'All projects comply with contractual deadlines.',
    'bank_guarantee.notify_sending': 'Sending...',
    'bank_guarantee.notify_bank': 'Notify bank',
    'bank_guarantee.view_project': 'View project',
    'bank_guarantee.delay_label': 'Delay',
    'bank_guarantee.days_label': 'days',
    'bank_guarantee.contractor_label': 'Contractor',
    'bank_guarantee.planned_date_label': 'Planned date',
    'bank_guarantee.milestones_missed_label': 'Milestones missed',
    'bank_guarantee.escalation_thresholds_title': 'Escalation thresholds',
    'bank_guarantee.delay_percentage_suffix': 'of delay',
    'bank_guarantee.severity_labels.delay_alert': 'Delay alert',
    'bank_guarantee.severity_labels.bank_notification': 'Bank notification',
    'bank_guarantee.severity_labels.guarantee_trigger': 'Guarantee trigger',
    'bank_guarantee.escalation.legal': 'Legal escalation',
    'bank_guarantee.actions.task_assignment_title': 'Project delay handling',
    'bank_guarantee.actions.task_assignment_msg_prefix': 'Please handle the delay of',
    'bank_guarantee.actions.hierarchy_notification_title': 'Critical delay alert',
    'bank_guarantee.actions.hierarchy_notification_msg_prefix': 'Project',
    'bank_guarantee.actions.sms_title': 'Project delay SMS',
    'bank_guarantee.actions.sms_msg_prefix': 'SMS: delay',
    'bank_guarantee.actions.call_title': 'Project delay call',
    'bank_guarantee.actions.call_msg_prefix': 'Call regarding the project delay',
    'bank_guarantee.actions.email_title': 'Project delay email',
    'bank_guarantee.actions.email_msg_prefix': 'Email regarding the project delay',
    'bank_guarantee.actions.mail_title': 'Project delay letter',
    'bank_guarantee.actions.mail_msg_prefix': 'Letter regarding the project delay',
    'bank_guarantee.unknown_action_type': 'Unknown action type',
    'bank_guarantee.action_created_success': '{title} created successfully',
    'bank_guarantee.alerts_title': 'Bank guarantee alerts',
    'bank_guarantee.alert_acknowledged': 'Alert acknowledged',
    'bank_guarantee.alert_acknowledge_error': 'Unable to acknowledge the alert',
    'bank_guarantee.alert_resolved': 'Alert resolved',
    'bank_guarantee.alert_resolve_error': 'Unable to resolve the alert',
    'bank_guarantee.delay_percent_prefix': 'Delay',
    'documents.employee.updated_successfully': 'Document updated successfully.',
    'projects.import.importMode': 'Import mode',
    'projects.import.modeCreate': 'Create or update',
    'projects.import.modeUpdate': 'Full update',
    'projects.import.modePatch': 'Partial update',
    'projects.import.modeCreateDesc': 'Creates new projects and updates existing ones based on their business reference.',
    'projects.import.modeUpdateDesc': 'Replaces the data of existing projects matching their business reference.',
    'projects.import.modePatchDesc': 'Updates only the fields provided in the file.',
    'projects.import.projectsCreated': 'project(s) created',
    'projects.import.projectsUpdated': 'project(s) updated',
    'projects.view_details': 'View details',
    'materials.documents.title': 'Material documents',
    'materials.documents.subtitle': 'Manage all material documents (invoices, certificates, user manual)',
    'materials.documents.upload_title': 'Document upload',
    'materials.documents.upload_description': 'Upload the documents to attach to this material',
    'materials.documents.types.invoice': 'Invoice',
    'materials.documents.types.warranty': 'Warranty',
    'materials.documents.types.certificate': 'Certificate',
    'materials.documents.types.manual': 'Manual',
    'materials.documents.invoice_desc': 'Purchase and delivery evidence',
    'materials.documents.certificate_desc': 'Quality, compliance, safety',
    'materials.documents.manual_desc': 'Usage instructions',
    'materials.documents.warranty_desc': 'Warranty documents',
    'materials.documents.save_reminder_title': 'Automatic save',
    'materials.documents.save_reminder_text': 'Documents will be attached to the material automatically after its creation.',
    'materials.none_selected': 'Nothing selected',
    'materials.last_updated': 'Last updated',
    'materials.sources_title': 'Price sources',
    'materials.no_sources': 'No price source',
    'materials.add_sources_hint': 'Add a source to trace the origin of the unit price.',
    'materials.updated_success': 'The material has been updated.',
    'inspection_monitoring.title': 'Inspection monitoring',
    'inspection_monitoring.subtitle': 'Inspection planning, execution and compliance',
};
...
deepMergeMissing(
    (translations as unknown as Record<string, Record<string, unknown>>).ar,
    expandFlatKeys(AR_ADDITIONS_FLAT)
);
deepMergeMissing(
    (translations as unknown as Record<string, Record<string, unknown>>).en,
...
const PHASE_STRUCTURE_KEYS = {
    fr: {
        'wbs.label': 'Structure de découpage des travaux',
        ...
        'workflow.step_counter': 'Étape {current} sur {total}',
        'workflow.progress_percent': '{value} %',
        'workflow.steps_aria': 'Étapes du workflow projet',
        'workflow.saving': 'Sauvegarde…',
        'workflow.unsaved_changes': 'Modifications non sauvegardées',
        'workflow.saved_at': 'Sauvegardé à {time}',
        'workflow.corrections_required': 'Corrections requises',
        'workflow.complete': 'Complète',
        'workflow.to_complete': 'À compléter',
        'workflow.no_changes': 'Aucune modification à sauvegarder',
        'workflow.save_step': 'Sauvegarder l’étape',
        'workflow.complete_required': 'Complétez les champs requis pour continuer',
        'workflow.save_and_next': 'Sauvegarder et passer à l’étape suivante',
        'workflow.incomplete_title': 'Étape incomplète',
        'workflow.incomplete_description': 'Veuillez compléter les champs requis avant de continuer.',
        ...
        'common.save_error': 'Impossible de sauvegarder',
        'common.status_update_error': 'Impossible de mettre à jour le statut',
        'common.items_count': '{count} élément(s)',
        'common.roles_count': '{count} rôle(s)',
        'auth.login': 'Se connecter',
        'phase.auth_required': 'Vous devez être connecté pour gérer les phases de construction.',
        'phase.project_phases': 'Phases du projet ({count})',
        'phase.confirm_delete': 'Êtes-vous sûr de vouloir supprimer cette phase ?',
        'phase.view_details': 'Voir les détails de la phase',
        'phase.delete': 'Supprimer la phase',
        'phase.steps': 'Étapes :',
        'phase.additional_steps': '+ {count} étape(s) supplémentaire(s)',
        'milestone.generated': 'Jalons générés',
        'milestone.generated_count': '{count} jalon(s) créé(s) depuis le référentiel.',
        'milestone.generate_error': 'Impossible de générer les jalons.',
        'milestone.updated': 'Jalon modifié',
        'milestone.added': 'Jalon ajouté',
        'milestone.marked_pending': 'Jalon marqué comme en attente',
        'milestone.marked_completed': 'Jalon marqué comme terminé',
        'milestone.phase_title': 'Jalons de la phase',
        'milestone.progress_completed': '{value} % complété',
        'milestone.edit_title': 'Modifier un jalon',
        'milestone.add_title': 'Ajouter un jalon',
        'milestone.title_placeholder': 'Titre du jalon',
        'milestone.description_placeholder': 'Description du jalon',
        'milestone.target_date': 'Date cible',
        'milestone.weight': 'Poids (0,1 à 1,0)',
        'milestone.notes_placeholder': 'Notes additionnelles',
        'milestone.phase_inspections': 'Inspections de la phase',
        'milestone.linked_payments': 'Paiements liés',
        'milestone.none_hint': 'Aucun jalon pour cette phase — générez-les depuis le référentiel projet puis ajustez-les.',
        'milestone.weight_value': 'Poids : {value}',
        'milestone.target': 'Cible :',
        'milestone.completed_on': 'Terminé :',
        'milestone.mark_pending': 'Marquer en attente',
        'milestone.mark_completed': 'Marquer terminé',
        'workflow.required_steps': 'Les étapes {steps} sont requises',
        'workflow.invalid_steps': 'Les étapes {steps} comportent des erreurs',
        'workflow.final_validation': 'Validation finale',
        'workflow.complete_required_before_validation': 'Veuillez compléter toutes les étapes requises avant de valider le projet.',
        'workflow.ready_to_create': 'Toutes les étapes sont complètes. Vous pouvez maintenant créer le projet.',
        'workflow.all_complete_ready_create': 'Toutes les étapes sont complètes — prêt à créer le projet',
        'project_create.created_named': 'Projet « {title} » créé avec succès',
        'project_create.create_error': 'Erreur lors de la création',
        'project_create.workflow_description': 'Créez un nouveau projet en suivant les étapes du workflow',
        'workflow.no_form_data': 'Aucune donnée de formulaire disponible',
        'workflow.completion_error': 'Impossible de terminer la création du projet',
        'workflow.project_created_complete': 'Le projet a été créé et toutes les étapes sont complétées',
        'workflow.ready_to_update': 'Toutes les étapes sont complètes. Vous pouvez maintenant mettre à jour le projet.',
        'workflow.all_complete_ready_update': 'Toutes les étapes sont complètes — prêt à mettre à jour le projet',
        'workflow.validation_step_required': 'Étape de validation — veuillez compléter toutes les étapes requises',
        'project_edit.loading_error': 'Erreur de chargement',
        'project_edit.loading': 'Chargement du projet…',
        'project_edit.missing_id': 'Identifiant projet manquant.',
        'project_edit.load_failed': 'Impossible de charger les données du projet.',
        'project_edit.retry': 'Réessayer',
        'project_edit.updated': 'Projet mis à jour',
        'project_edit.update_error': 'Erreur lors de la mise à jour',
        'project_edit.refreshed': 'Actualisé',
        'project_edit.refreshed_description': 'Les données du projet ont été mises à jour',
        'project_edit.description': 'Modification du projet « {title} »',
        'project_edit.complete': 'Projet complet',
        'project_edit.last_updated': 'Dernière mise à jour : {date}',
        'quantity.calculate_add': 'Calculer et ajouter',
        'quantity.reset': 'Réinitialiser',
        'quantity.processing': 'Traitement…',
        'quantity.import': 'Importer (PDF/Excel/CSV)',
        'quantity.previous_page': 'Page précédente',
        'quantity.next_page': 'Page suivante',
        'quantity.page': 'Page {current} sur {total}',
        'quantity.lines_range': 'Lignes {start}–{end} sur {total}',
        'quantity.saving': 'Enregistrement…',
        'quantity.save_count': 'Enregistrer ({count})',
        'quantity.sending': 'Envoi…',
        'quantity.send_to_boq': 'Envoyer vers le bordereau ({count})',
        'quantity.export_csv': 'Exporter en CSV',
        'quantity.clear_all': 'Tout effacer',
        'quantity.linked_phase': 'Phase associée',
        'quantity.estimate_detail': 'Détail estimatif ({count} lignes)',
        'quantity.openings': 'Ouvertures',
        'quantity.add_opening': 'Ajouter une ouverture',
        'quantity.reference_material': 'Matériau de référence',
        'quantity.select_material': 'Sélectionner un matériau…',
        'quantity.default_resource_type': 'Type de ressource par défaut',
        'quantity.default_unit_price': 'Prix unitaire par défaut (optionnel)',
        'quantity.auto_recommendations': 'Générer une ligne par recommandation ({count}) avec le prix unitaire du matériau',
        'quantity.invalid_opening': 'Dimensions invalides pour l’ouverture',
        'quantity.required_dimensions': 'Veuillez renseigner toutes les dimensions requises',
        'project_workflow.steps.project_info.title': 'Informations du projet',
        'project_workflow.steps.project_info.description': 'Type, budget, dates et référence',
        'project_workflow.steps.stakeholders.title': 'Parties prenantes',
        'project_workflow.steps.stakeholders.description': 'Bailleurs, ministères, entreprises, banques et bureau conseil',
        'project_workflow.steps.location.title': 'Localisation',
        'project_workflow.steps.location.description': 'Géolocalisation interactive',
        'project_workflow.steps.wbs.title': 'Structure de découpage des travaux',
        'project_workflow.steps.wbs.description': 'Phases, étapes et tâches avec documents, ressources et inspections',
        'project_workflow.steps.risks.title': 'Risques',
        'project_workflow.steps.risks.description': 'Analyse et gestion des risques',
        'project_workflow.steps.compliance.title': 'Conformité',
        'project_workflow.steps.compliance.description': 'Standards de l’entreprise et des bailleurs',
        'project_workflow.steps.strategic_linkage.title': 'Liaisons stratégiques',
        'project_workflow.steps.strategic_linkage.description': 'SCAPP et loi de finances',
        'project_workflow.steps.validation.title': 'Validation',
        'project_workflow.steps.validation.description': 'Réception définitive et clôture',
    },
    ar: {
        'wbs.label': 'هيكل تجزئة العمل',
        ...
        'workflow.step_counter': 'الخطوة {current} من {total}',
        'workflow.progress_percent': '{value}٪',
        'workflow.steps_aria': 'خطوات سير عمل المشروع',
        'workflow.saving': 'جارٍ الحفظ…',
        'workflow.unsaved_changes': 'تغييرات غير محفوظة',
        'workflow.saved_at': 'حُفظ في {time}',
        'workflow.corrections_required': 'تصحيحات مطلوبة',
        'workflow.complete': 'مكتملة',
        'workflow.to_complete': 'تحتاج إلى إكمال',
        'workflow.no_changes': 'لا توجد تغييرات للحفظ',
        'workflow.save_step': 'حفظ الخطوة',
        'workflow.complete_required': 'أكمل الحقول المطلوبة للمتابعة',
        'workflow.save_and_next': 'حفظ والانتقال إلى الخطوة التالية',
        'workflow.incomplete_title': 'الخطوة غير مكتملة',
        'workflow.incomplete_description': 'يرجى إكمال الحقول المطلوبة قبل المتابعة.',
        ...
        'common.save_error': 'تعذر الحفظ',
        'common.status_update_error': 'تعذر تحديث الحالة',
        'common.items_count': '{count} عنصر',
        'common.roles_count': '{count} دور',
        'auth.login': 'تسجيل الدخول',
        'phase.auth_required': 'يجب تسجيل الدخول لإدارة مراحل البناء.',
        'phase.project_phases': 'مراحل المشروع ({count})',
        'phase.confirm_delete': 'هل أنت متأكد من حذف هذه المرحلة؟',
        'phase.view_details': 'عرض تفاصيل المرحلة',
        'phase.delete': 'حذف المرحلة',
        'phase.steps': 'الخطوات:',
        'phase.additional_steps': '+ {count} خطوة إضافية',
        'milestone.generated': 'تم إنشاء المعالم',
        'milestone.generated_count': 'تم إنشاء {count} معلم من المرجعية.',
        'milestone.generate_error': 'تعذر إنشاء المعالم.',
        'milestone.updated': 'تم تعديل المعلم',
        'milestone.added': 'تمت إضافة المعلم',
        'milestone.marked_pending': 'تم وضع المعلم في الانتظار',
        'milestone.marked_completed': 'تم وضع علامة مكتمل على المعلم',
        'milestone.phase_title': 'معالم المرحلة',
        'milestone.progress_completed': 'مكتمل بنسبة {value}٪',
        'milestone.edit_title': 'تعديل معلم',
        'milestone.add_title': 'إضافة معلم',
        'milestone.title_placeholder': 'عنوان المعلم',
        'milestone.description_placeholder': 'وصف المعلم',
        'milestone.target_date': 'التاريخ المستهدف',
        'milestone.weight': 'الوزن (0.1 إلى 1.0)',
        'milestone.notes_placeholder': 'ملاحظات إضافية',
        'milestone.phase_inspections': 'عمليات تفتيش المرحلة',
        'milestone.linked_payments': 'المدفوعات المرتبطة',
        'milestone.none_hint': 'لا يوجد معلم لهذه المرحلة — أنشئ المعالم من مرجعية المشروع ثم عدّلها.',
        'milestone.weight_value': 'الوزن: {value}',
        'milestone.target': 'المستهدف:',
        'milestone.completed_on': 'اكتمل:',
        'milestone.mark_pending': 'وضع في الانتظار',
        'milestone.mark_completed': 'وضع علامة مكتمل',
        'workflow.required_steps': 'الخطوات {steps} مطلوبة',
        'workflow.invalid_steps': 'تحتوي الخطوات {steps} على أخطاء',
        'workflow.final_validation': 'المصادقة النهائية',
        'workflow.complete_required_before_validation': 'يرجى إكمال جميع الخطوات المطلوبة قبل اعتماد المشروع.',
        'workflow.ready_to_create': 'اكتملت جميع الخطوات. يمكنك الآن إنشاء المشروع.',
        'workflow.all_complete_ready_create': 'اكتملت جميع الخطوات — المشروع جاهز للإنشاء',
        'project_create.created_named': 'تم إنشاء المشروع «{title}» بنجاح',
        'project_create.create_error': 'حدث خطأ أثناء الإنشاء',
        'project_create.workflow_description': 'أنشئ مشروعًا جديدًا باتباع خطوات سير العمل',
        'workflow.no_form_data': 'لا توجد بيانات نموذج متاحة',
        'workflow.completion_error': 'تعذر إكمال إنشاء المشروع',
        'workflow.project_created_complete': 'تم إنشاء المشروع وإكمال جميع الخطوات',
        'workflow.ready_to_update': 'اكتملت جميع الخطوات. يمكنك الآن تحديث المشروع.',
        'workflow.all_complete_ready_update': 'اكتملت جميع الخطوات — المشروع جاهز للتحديث',
        'workflow.validation_step_required': 'خطوة المصادقة — يرجى إكمال جميع الخطوات المطلوبة',
        'project_edit.loading_error': 'خطأ في التحميل',
        'project_edit.loading': 'جارٍ تحميل المشروع…',
        'project_edit.missing_id': 'معرّف المشروع مفقود.',
        'project_edit.load_failed': 'تعذر تحميل بيانات المشروع.',
        'project_edit.retry': 'إعادة المحاولة',
        'project_edit.updated': 'تم تحديث المشروع',
        'project_edit.update_error': 'حدث خطأ أثناء التحديث',
        'project_edit.refreshed': 'تم التحديث',
        'project_edit.refreshed_description': 'تم تحديث بيانات المشروع',
        'project_edit.description': 'تعديل المشروع «{title}»',
        'project_edit.complete': 'المشروع مكتمل',
        'project_edit.last_updated': 'آخر تحديث: {date}',
        'quantity.calculate_add': 'احسب وأضف',
        'quantity.reset': 'إعادة التعيين',
        'quantity.processing': 'جارٍ المعالجة…',
        'quantity.import': 'استيراد (PDF/Excel/CSV)',
        'quantity.previous_page': 'الصفحة السابقة',
        'quantity.next_page': 'الصفحة التالية',
        'quantity.page': 'الصفحة {current} من {total}',
        'quantity.lines_range': 'الأسطر {start}–{end} من {total}',
        'quantity.saving': 'جارٍ الحفظ…',
        'quantity.save_count': 'حفظ ({count})',
        'quantity.sending': 'جارٍ الإرسال…',
        'quantity.send_to_boq': 'إرسال إلى جدول الكميات ({count})',
        'quantity.export_csv': 'تصدير CSV',
        'quantity.clear_all': 'مسح الكل',
        'quantity.linked_phase': 'المرحلة المرتبطة',
        'quantity.estimate_detail': 'تفاصيل التقدير ({count} سطر)',
        'quantity.openings': 'الفتحات',
        'quantity.add_opening': 'إضافة فتحة',
        'quantity.reference_material': 'المادة المرجعية',
        'quantity.select_material': 'اختر مادة…',
        'quantity.default_resource_type': 'نوع المورد الافتراضي',
        'quantity.default_unit_price': 'سعر الوحدة الافتراضي (اختياري)',
        'quantity.auto_recommendations': 'إنشاء سطر لكل توصية ({count}) باستخدام سعر وحدة المادة',
        'quantity.invalid_opening': 'أبعاد الفتحة غير صالحة',
        'quantity.required_dimensions': 'يرجى إدخال جميع الأبعاد المطلوبة',
        'project_workflow.steps.project_info.title': 'معلومات المشروع',
        'project_workflow.steps.project_info.description': 'النوع والميزانية والتواريخ والمرجع',
        'project_workflow.steps.stakeholders.title': 'أصحاب المصلحة',
        'project_workflow.steps.stakeholders.description': 'الجهات المانحة والوزارات والشركات والبنوك والمكتب الاستشاري',
        'project_workflow.steps.location.title': 'الموقع',
        'project_workflow.steps.location.description': 'تحديد الموقع الجغرافي التفاعلي',
        'project_workflow.steps.wbs.title': 'هيكل تجزئة العمل',
        'project_workflow.steps.wbs.description': 'المراحل والخطوات والمهام مع الوثائق والموارد وعمليات التفتيش',
        'project_workflow.steps.risks.title': 'المخاطر',
        'project_workflow.steps.risks.description': 'تحليل المخاطر وإدارتها',
        'project_workflow.steps.compliance.title': 'الامتثال',
        'project_workflow.steps.compliance.description': 'معايير المؤسسة والجهات المانحة',
        'project_workflow.steps.strategic_linkage.title': 'الروابط الاستراتيجية',
        'project_workflow.steps.strategic_linkage.description': 'استراتيجية النمو المتسارع والرفاه المشترك وقانون المالية',
        'project_workflow.steps.validation.title': 'المصادقة',
        'project_workflow.steps.validation.description': 'الاستلام النهائي والإغلاق',
    },
    en: {
        'wbs.label': 'Work breakdown structure',
        ...
        'workflow.step_counter': 'Step {current} of {total}',
        'workflow.progress_percent': '{value}%',
        'workflow.steps_aria': 'Project workflow steps',
        'workflow.saving': 'Saving…',
        'workflow.unsaved_changes': 'Unsaved changes',
        'workflow.saved_at': 'Saved at {time}',
        'workflow.corrections_required': 'Corrections required',
        'workflow.complete': 'Complete',
        'workflow.to_complete': 'To complete',
        'workflow.no_changes': 'No changes to save',
        'workflow.save_step': 'Save step',
        'workflow.complete_required': 'Complete the required fields to continue',
        'workflow.save_and_next': 'Save and go to the next step',
        'workflow.incomplete_title': 'Incomplete step',
        'workflow.incomplete_description': 'Please complete the required fields before continuing.',
        ...
        'common.save_error': 'Unable to save',
        'common.status_update_error': 'Unable to update status',
        'common.items_count': '{count} item(s)',
        'common.roles_count': '{count} role(s)',
        'auth.login': 'Sign in',
        'phase.auth_required': 'You must be signed in to manage construction phases.',
        'phase.project_phases': 'Project phases ({count})',
        'phase.confirm_delete': 'Are you sure you want to delete this phase?',
        'phase.view_details': 'View phase details',
        'phase.delete': 'Delete phase',
        'phase.steps': 'Steps:',
        'phase.additional_steps': '+ {count} additional step(s)',
        'milestone.generated': 'Milestones generated',
        'milestone.generated_count': '{count} milestone(s) created from the referential.',
        'milestone.generate_error': 'Unable to generate milestones.',
        'milestone.updated': 'Milestone updated',
        'milestone.added': 'Milestone added',
        'milestone.marked_pending': 'Milestone marked as pending',
        'milestone.marked_completed': 'Milestone marked as completed',
        'milestone.phase_title': 'Phase milestones',
        'milestone.progress_completed': '{value}% completed',
        'milestone.edit_title': 'Edit milestone',
        'milestone.add_title': 'Add milestone',
        'milestone.title_placeholder': 'Milestone title',
        'milestone.description_placeholder': 'Milestone description',
        'milestone.target_date': 'Target date',
        'milestone.weight': 'Weight (0.1 to 1.0)',
        'milestone.notes_placeholder': 'Additional notes',
        'milestone.phase_inspections': 'Phase inspections',
        'milestone.linked_payments': 'Linked payments',
        'milestone.none_hint': 'No milestone for this phase — generate them from the project referential, then adjust them.',
        'milestone.weight_value': 'Weight: {value}',
        'milestone.target': 'Target:',
        'milestone.completed_on': 'Completed:',
        'milestone.mark_pending': 'Mark as pending',
        'milestone.mark_completed': 'Mark as completed',
        'workflow.required_steps': 'Steps {steps} are required',
        'workflow.invalid_steps': 'Steps {steps} contain errors',
        'workflow.final_validation': 'Final validation',
        'workflow.complete_required_before_validation': 'Please complete all required steps before validating the project.',
        'workflow.ready_to_create': 'All steps are complete. You can now create the project.',
        'workflow.all_complete_ready_create': 'All steps are complete — ready to create the project',
        'project_create.created_named': 'Project “{title}” created successfully',
        'project_create.create_error': 'An error occurred while creating the project',
        'project_create.workflow_description': 'Create a new project by following the workflow steps',
        'workflow.no_form_data': 'No form data available',
        'workflow.completion_error': 'Unable to complete project creation',
        'workflow.project_created_complete': 'The project was created and all steps are complete',
        'workflow.ready_to_update': 'All steps are complete. You can now update the project.',
        'workflow.all_complete_ready_update': 'All steps are complete — ready to update the project',
        'workflow.validation_step_required': 'Validation step — please complete all required steps',
        'project_edit.loading_error': 'Loading error',
        'project_edit.loading': 'Loading project…',
        'project_edit.missing_id': 'Project identifier is missing.',
        'project_edit.load_failed': 'Unable to load project data.',
        'project_edit.retry': 'Retry',
        'project_edit.updated': 'Project updated',
        'project_edit.update_error': 'An error occurred while updating',
        'project_edit.refreshed': 'Refreshed',
        'project_edit.refreshed_description': 'Project data has been updated',
        'project_edit.description': 'Editing project “{title}”',
        'project_edit.complete': 'Project complete',
        'project_edit.last_updated': 'Last updated: {date}',
        'quantity.calculate_add': 'Calculate and add',
        'quantity.reset': 'Reset',
        'quantity.processing': 'Processing…',
        'quantity.import': 'Import (PDF/Excel/CSV)',
        'quantity.previous_page': 'Previous page',
        'quantity.next_page': 'Next page',
        'quantity.page': 'Page {current} of {total}',
        'quantity.lines_range': 'Lines {start}–{end} of {total}',
        'quantity.saving': 'Saving…',
        'quantity.save_count': 'Save ({count})',
        'quantity.sending': 'Sending…',
        'quantity.send_to_boq': 'Send to bill of quantities ({count})',
        'quantity.export_csv': 'Export CSV',
        'quantity.clear_all': 'Clear all',
        'quantity.linked_phase': 'Linked phase',
        'quantity.estimate_detail': 'Estimate details ({count} lines)',
        'quantity.openings': 'Openings',
        'quantity.add_opening': 'Add opening',
        'quantity.reference_material': 'Reference material',
        'quantity.select_material': 'Select a material…',
        'quantity.default_resource_type': 'Default resource type',
        'quantity.default_unit_price': 'Default unit price (optional)',
        'quantity.auto_recommendations': 'Generate one line per recommendation ({count}) using the material unit price',
        'quantity.invalid_opening': 'Invalid opening dimensions',
        'quantity.required_dimensions': 'Please enter all required dimensions',
        'project_workflow.steps.project_info.title': 'Project information',
        'project_workflow.steps.project_info.description': 'Type, budget, dates and reference',
        'project_workflow.steps.stakeholders.title': 'Stakeholders',
        'project_workflow.steps.stakeholders.description': 'Donors, ministries, companies, banks and consulting firm',
        'project_workflow.steps.location.title': 'Location',
        'project_workflow.steps.location.description': 'Interactive geolocation',
        'project_workflow.steps.wbs.title': 'Work breakdown structure',
        'project_workflow.steps.wbs.description': 'Phases, steps and tasks with documents, resources and inspections',
        'project_workflow.steps.risks.title': 'Risks',
        'project_workflow.steps.risks.description': 'Risk analysis and management',
        'project_workflow.steps.compliance.title': 'Compliance',
        'project_workflow.steps.compliance.description': 'Company and donor standards',
        'project_workflow.steps.strategic_linkage.title': 'Strategic alignment',
        'project_workflow.steps.strategic_linkage.description': 'SCAPP and Finance Act',
        'project_workflow.steps.validation.title': 'Validation',
        'project_workflow.steps.validation.description': 'Final acceptance and closure',
    },
} as const;
